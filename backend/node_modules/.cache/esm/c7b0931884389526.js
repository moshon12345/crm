let con;_843‍.x([["getContacts",()=>getContacts],["addContact",()=>addContact],["deleteContact",()=>deleteContact],["getContact",()=>getContact],["updateContact",()=>updateContact],["getContactDetails",()=>getContactDetails],["getContactSearch",()=>getContactSearch]]);_843‍.w("../sqlConnect",[["con",["con"],function(v){con=v}]]);

       function getContacts(req, res) {
    con.query("SELECT * FROM `contacts`", (err, result) => {
        if (err) {
            _843‍.g.console.log(err);
        }
